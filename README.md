...
This is forked from [dabreadman](https://github.com/dabreadman/sync-upstream-repo), with extra functionality from [verticalsync](https://github.com/verticalsync/sync-upstream-repo).
